"""
Django settings for datobi_blog project.
...
SECRET_KEY = 'django-insecure-3tr+k==6zv7$@=!5h-tc_83c*-3wo06&!45l!nilu#m!#&lz=)'
...
WSGI_APPLICATION = 'datobi_blog.wsgi.application'
